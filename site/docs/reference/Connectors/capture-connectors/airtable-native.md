...
There are two different ways to authenticate with Airtable when capturing data into Flow: using OAuth or using an access token. Both require an active Airtable account.
